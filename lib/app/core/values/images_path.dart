...
const first_on_boarding = "${baseUrl}board_1.svg";
const second_on_boarding = "${baseUrl}board_2.svg";
const third_on_boarding = "${baseUrl}board_3.svg";
const splashScreen = "${baseUrl}splashScreen.png";
